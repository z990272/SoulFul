    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Soulful.Models.SoulfulContext>
    {
        ...
        protected override void Seed(Soulful.Models.SoulfulContext context)
        {
            ...
            context.Album.AddOrUpdate(x => x.Album_id,
                 new Album { Album_id = 35, Singer_id = 69, Datetime = new DateTime(2015, 09, 22), Album_Name = "我要你好好的", Pic = "劉若英-我要你好好的.jpg", Price = 419, Company = "相信音樂", About = "無論去到哪裡、經歷了什麼，請你一定要記得，你並不孤單。因為，我一直在這裡。我要你好好的。",Video= "TxemOZuhpXI" },
                 new Album { Album_id =36, Singer_id =70, Datetime = new DateTime(2020, 05, 15), Album_Name = "太空人", Pic = "Spaceman.jpg", Price = 2020, Company = "UNI/環球", About = "2020.05.15 太空日誌宇宙航行的時間，與地球是有時差的。在《太空人》的宇宙裡，我們一起經歷了專輯發行、抵達《太空備忘記》每顆星球、看見《太空人》線上影展一部部美如藝術品般的音樂錄影帶，也經歷突如其來隕石般的不可預期、黑洞距離的拉扯......過程裡，我們曾停航，當中的我們，有些只能遙望著，但卻因為音樂能夠繼續閃爍，感受每次的流淚歌頌......。現在，我們再次重拾一切的原點，那是音樂的本質。", Video = "LV7eT2_VwMw" },
                 new Album { Album_id = 37, Singer_id = 71, Datetime = new DateTime(2020, 07, 10), Album_Name = "Outta body靈魂出竅", Pic = "瘦子ESO-靈魂出竅.jpg", Price = 458, Company = "滾石唱片", About = "瘦子E.SO從頑童出道至今，走過精彩光輝的音樂歷程也替華語市場帶來豐富多元的嘻哈新局面有人說饒舌歌手是社會觀察家，透過音樂唱出世俗紅塵的大小事音樂是他們的生命歷程，五感則是他們的靈感來源不論你認識的是《Just Believe》那個因夢想而偉大的他還是《脫罪》中深思沉靜的成熟內斂的青年 ; 亦或是《地痞》裡訴說自我始終如一態度十足的 瘦子E.SO但不論是哪個角色，哪個他，經歷歲月的洗鍊，在頑童單飛不解散後他對生命有了更深的體悟頂著金曲光環，背負多人的期待，2020 瘦子E.SO 將帶給大家全新的思維角度與音樂感受，宣告大家我的改變即是我的音樂歷程上的新開端，在這個新的十年，他將帶給大家更多新觀點，更不忘初心的用音樂闡述更多關於他對於愛的議題",Video= "HTRQ0n4yjfs" },
                 new Album { Album_id = 38, Singer_id = 72, Datetime = new DateTime(2020, 06, 15), Album_Name = "新世界", Pic = "華晨宇-新世界.jpg", About = "因果輪迴，生命探索，花花宇宙，唱出自我打破舊規則，開創新世界華語樂壇新生代領軍唱作人華晨宇第四張全新創作專輯，新世界ＮＥＷ ＷＯＲＬＤ改造音樂新三觀，引領華流新格局", Price = 668, Company = "SONY MUSIC",Video= "42HkK9FGiHk" },
                 new Album { Album_id = 39, Singer_id = 73, Datetime = new DateTime(2019, 12, 11), Album_Name = "天氣之子", Pic = "RADWIMPS.jpg", Price = 1599, Company = "UNI(環球)",Video= "KYV1GOQdi4s" },
                 new Album { Album_id = 40, Singer_id = 74, Datetime = new DateTime(2019, 09, 06), Album_Name = "DELIGHT", Pic = "伯賢-DELIGHT.jpg", Price = 509, Company = "SM ENTERTAINMENT",Video= "gmgcRWxhmqY" },
                 ...
                 new Album { Album_id = 42, Singer_id = 76, Datetime = new DateTime(2020, 06, 03), Album_Name = "Chromatica (Standard Edtion)神彩", Pic = "LADYGAGA.jpg", About = "每一個世代都需要一位能夠引領潮流、顛覆世代的前衛人物作為指標，成為當代人們情感出口與追循目標；1960-70年代「大衛鮑伊David Bowie」雌雄莫辨的陰柔形象、80-90年代「瑪丹娜Madonna」將女性主義提升到全球皆知；進入21世紀，全球樂壇最具指標性人物非「女神卡卡LADY GAGA」莫屬，她不斷在音樂、流行、藝術等領域帶動風潮，躍升當代最重要的流行文化唯一巨星。2020年，LADY GAGA再次帶著全新作品回到樂壇，以她最擅長的流行舞曲預備再創音樂新領域。", Price = 399, Company = "UNI(環球)",Video= "5L6xyaeiV58" },
                 new Album { Album_id = 43, Singer_id = 77, Datetime = new DateTime(2020, 05, 15), Album_Name = "inK", Pic = "KEITA-inK.jpg", About = "w-inds.主唱 - 橘慶太KEITA推出睽違4年、收錄14首精彩樂曲的第3張個人專輯.w - inds.裡負責主唱，同時也身兼歌曲製作的橘慶太，以SOLO PROJECT “KEITA”的名義，透過許多海外流行音樂要素，並受到眾多音樂人及創作者的關注。KEITA以身為歌手／作曲者嘗試探索多樣的可能性，推出睽違4年的第3張個人專輯。專輯《inK》的意思代表KEITA自我本身，收錄2019年數位發行的12首歌曲外，另外追加收錄2首新曲〈Tokyo Night Fighter〉、〈Someday〉。本張專輯KEITA不只挑戰全部樂曲的作詞、作編曲，另外也參與了混音及後期處理，是一張由KEITA完整打造的個人專輯。台壓初回盤DVD收錄寫給母親的新曲〈Someday〉的製作過程，約40分鐘的幕後花絮，將可看到KEITA私下與工作人員開會、拍攝專輯封面以及在錄音室製作樂曲的各種花絮。DVD附中文字幕。", Company = "洧誠國際有限公司", Price = 369,Video= "vPqX5RHDTWI" }
                 );
